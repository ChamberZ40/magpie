...
//
// silently destroying the user's session on magpie restart / idle reset.
...
`
	...
	if !strings.HasPrefix(imagePath, filepath.Join(workDir, ".magpie", "images")+string(filepath.Separator)) {
