...
//
// Full inventory: projects/magpie/agents/qa-cursor/release-gate/CUJ-INVENTORY.md
package core
...
// ===========================================================================
// CUJ-D7 · outgoing_rate_limit throttles bursts so magpie does not get
...
// ===========================================================================
// CUJ-B12 · After magpie restarts, the user's session, history, agent
...
func TestCUJ_D6_InboundRateLimitDrops(t *testing.T) {
	...
	// (or 1 if magpie reuses session per burst).
	if n > 2 {
...
// CUJ-H1 · Two projects in one magpie: sessions/messages do not cross
