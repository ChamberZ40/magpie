...
func TestResolveMaxAttachmentSize(t *testing.T) {
	...
	t.Setenv("MAGPIE_MAX_ATTACHMENT_SIZE_MB", "")
	...
	t.Setenv("MAGPIE_MAX_ATTACHMENT_SIZE_MB", "1024") // 1024 MiB = 1 GiB
