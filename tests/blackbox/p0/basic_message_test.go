...
// user sends a message → magpie routes it to Claude Code → user receives
// a non-empty reply.
//
...
// magpie sends a confirmation message.
...
// TestP0_5_StopCurrentTask_ClaudeCode verifies /stop causes magpie to
