...
// service. Tests inject messages via InjectMessage and verify magpie's
...
// SentMessage captures a single outbound call from magpie to the platform.
...
// InjectMessage simulates a user sending a plain-text message to magpie.
...
// turn when magpie may send multiple messages per turn (thinking indicators,
