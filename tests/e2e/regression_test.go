...
// Package e2e contains smoke and regression tests for magpie.
...
import (
	...
	"github.com/ChamberZ40/magpie/tests/mocks"
	"github.com/ChamberZ40/magpie/tests/mocks/fake"
...
func TestRegression_DiscordEmbed(t *testing.T) {
	...
	assert.Equal(t, "magpie v1.0", embed.Footer.Text)
